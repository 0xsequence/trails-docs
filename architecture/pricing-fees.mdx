...
|----------|-------------|---------|
| **Origin Gas** | Gas to execute the transaction on the source chain | Network validators |
| **Destination Gas** | Gas to execute the transaction on the target chain | Network validators |
| **Bridge/LP Fees** | Fees charged by the underlying liquidity provider or bridge | Bridge/DEX protocols |
...
<Note>
For enterprise pricing or high-volume discounts, contact the team via the [Trails Telegram group](https://t.me/build_with_trails).
</Note>
