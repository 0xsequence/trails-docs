...
intent protocol from gas savings, flexibility, 1-click gasless flows, and expanding chain routes.
- The Trails API supports both v1 (original) and v1.5 (new) intent protocols out-of-the-box and
apps using older Trails SDK versions will default to using the v1 intent protocol as before.
- We recommend apps to upgrade to the latest `0xtrails@0.15.0` sdk to take advantage of many upgrades
and the new `v1.5` intent protocol.
