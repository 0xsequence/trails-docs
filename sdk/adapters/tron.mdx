...
<Warning>
`@0xtrails/tvm` requires a `Buffer` global in the browser. Set up the [polyfill](/sdk/adapters/overview#buffer-polyfill-for-tron) before importing the adapter, or the page renders blank.
</Warning>
