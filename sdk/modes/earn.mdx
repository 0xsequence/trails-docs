...
<Note>
Earn mode includes both deposit and withdrawal tabs. If you want to deep-link users directly into withdrawals, use [Withdraw mode](/sdk/modes/withdraw).
</Note>
...
- [Hooks Reference](/sdk/hooks) - `TRAILS_ROUTER_PLACEHOLDER_AMOUNT` constant
