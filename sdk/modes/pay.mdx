...
| `swapProvider` | `RouteProvider` | Swap provider: `"AUTO"` (default), `"RELAY"`, `"SUSHI"`, `"ZEROX"`, `"CCTP"` |
| `bridgeProvider` | `RouteProvider` | Bridge provider: `"AUTO"` (default), `"RELAY"`, `"CCTP"`, `"LZ_OFT"`, `"LZ_STARGATE"`, `"GASZIP"`, `"LIFI"` |
