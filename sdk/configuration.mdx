...
|------|------|----------|-------------|
| `projectAccessKey` | `string` | No | Your project access key provided by Trails |
...
| Prop | Type | Required | Description |
|------|------|----------|-------------|
| `gasless` | `boolean` | No | Enable alternative fee tokens that support permit() for transactions (default: `false`) |
