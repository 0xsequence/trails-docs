...
Hook for handling refunds from stuck or failed intent transactions. This hook provides utilities to sign and execute refund transactions to recover funds from intent addresses.
