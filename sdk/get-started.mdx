  ...
  return (
    <Pay
      ...
      onPaymentSuccess={({ intentId }) => {
        console.log('Payment completed:', intentId)
      }}
    >
  ...
  return (
    <Fund
      ...
      onFundingSuccess={({ intentId }) => {
        console.log('Funding completed:', intentId)
      }}
    >
...
export const WithdrawExample = () => {
  return (
    <Withdraw
      ...
      onWithdrawSuccess={({ intentId }) => {
        console.log('Withdrawal completed:', intentId)
      }}
    >
...
<Pay
  ...
  onPaymentSuccess={({ intentId }) => {
    console.log('Completed:', intentId)
  }}
