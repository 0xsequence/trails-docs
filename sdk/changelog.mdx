...
<CardGroup cols={1}>
  <Card title="0xtrails@0.19.0" icon="tag" href="/sdk/changelog/0xtrails-0.19.0">
    Unreleased · Stripe checkout via the `stripe` prop (pay any token, settle USD on your Stripe account), and `intentId` on every post-quote widget callback payload.
  </Card>
