...
Trails supports fiat onramps by default in fund mode, allowing users to purchase crypto directly with fiat currency and deposit it to any token on any supported chain. This is perfect for onboarding new users who don't yet hold crypto.
