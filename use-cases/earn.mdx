...
Ideal for a variety of yield-generating and staking scenarios:
...
- [**Composable Actions**](/use-cases/composable-actions) - Chain `lend`, `deposit`, and `swap` into a single intent without encoding calldata by hand
