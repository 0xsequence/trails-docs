...
Explore more about configuring and customizing payment flows:

- [**Pay Mode Configuration**](/sdk/modes/pay) - Complete configuration options and parameters for pay mode
...
- [**Hooks Reference**](/sdk/hooks) - Available hooks for programmatic control (useQuote, usePay, etc.)
- [**Tokens & Chains**](/sdk/tokens-and-chains) - Configure payment tokens and destination chains
- [**x402 Payment Example**](/examples/x402) - Advanced example with HTTP 402 payment flows
