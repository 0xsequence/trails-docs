...
|--------------|----------------|----------------|
| USDC on Base | ETH on Arbitrum | Bridge + Swap |
| USDT on Ethereum | USDC on Polygon | Bridge + Swap |
| ETH on Arbitrum | DAI on Optimism | Bridge + Swap |

## USDC Payment Examples

### Accept USDC on Base

Settle in USDC on Base—users pay from any chain:
...
For merchants preferring USDT settlement:
