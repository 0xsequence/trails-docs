...
### Initiating a Refund via the Explorer

Refunds can be initiated directly from the [Trails Explorer](https://app.trails.build/explorer). Simply connect the wallet you used to initiate the transaction and navigate to the intent that is pending. From there, you can initiate a manual refund.

### Initiating a Refund via the Widget

Refunds are also available in the **History** section of the Trails Widget embedded in your application. The widget will automatically detect intents that are eligible for a refund.
