...
### Accept USDC on Polygon (Lowest Fees)

Polygon offers low transaction fees for USDC settlement:
...
User pays with ETH on Arbitrum → Trails bridges and swaps → You receive USDC on Polygon.

### Accept USDC on Polygon for Recurring Charges
...
### Native USDC Bridging with CCTP (Polygon Settlement)
...
### Accept USDT on Polygon for Global Users
...
const SETTLEMENT_OPTIONS = [
  { chain: 137, token: 'USDC', label: 'USDC on Polygon' },
  { chain: 137, token: 'USDT', label: 'USDT on Polygon' },
